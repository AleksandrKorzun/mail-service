...
app.post("/send-email", async (req, res) => {
  ...
  const mailOptions = {
    ...
    // to: ["blacklionlimo001@gmail.com"], // Change to any recipient(s) you'd like
    to: ["korzun.oleksandr@gmail.com", "blacklionlimo001@gmail.com"], // Change to any recipient(s) you'd like
